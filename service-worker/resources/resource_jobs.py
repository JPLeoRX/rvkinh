...
from rvkinh_message_protocol import JobAttackHttpFloodStartInput, JobAttackHttpFloodStatusOutput, JobAttackPingFloodStartInput, JobAttackPingFloodStatusOutput, JobAttackSynFloodStartInput, JobAttackSynFloodStatusOutput
