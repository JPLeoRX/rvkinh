...
class ClientController:
    ...
    def worker_goal_haru(self, base_url: str, worker: Worker, timeout_in_seconds: int = 10) -> GoalHaru:
    ...
    def worker_goal_akio(self, base_url: str, worker: Worker, timeout_in_seconds: int = 10) -> GoalAkio:
    ...
    def attack_orchestration_start(self, base_url: str, attack_orchestration: AttackOrchestration, timeout_in_seconds: int = 10) -> bool:
    ...
    def attack_orchestration_stop(self, base_url: str, timeout_in_seconds: int = 10) -> bool:
    ...
    def attack_status(self, base_url: str, timeout_in_seconds: int = 10) -> AttackOrchestration:
        url = base_url + "/attack/status"
        headers = {'Content-Type': 'application/json'}
        response = requests.get(url, headers=headers, timeout=timeout_in_seconds)
        response.raise_for_status()
        response_json = response.json()
    ...
    def system_workers_alive(self, base_url: str, timeout_in_seconds: int = 10) -> List[Worker]:
